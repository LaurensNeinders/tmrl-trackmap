...
PRAGMA_MAP = RTGYM_INTERFACE.endswith("LIDARMAP")
PRAGMA_NEWTRACKMAP = RTGYM_INTERFACE.endswith("NEWTRACKMAP")
if (PRAGMA_PROGRESS or PRAGMA_MAP or PRAGMA_NEWTRACKMAP) :
    PRAGMA_LIDAR = True
